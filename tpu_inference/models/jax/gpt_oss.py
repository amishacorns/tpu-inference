...
class GptOss(nnx.Module):
    ...
    def load_weights(self, rng: PRNGKey, cache_dir: Optional[str] = None):
        ...
        swap_mlp_transform = (transforms["swap_last2"]
                              if quant_method in (MXFP4_QUANT_METHOD,
                                                   TPU_FP4_QUANT_METHOD) else
                              None)
    ...
    def _unpack_packed_fp4_to_fp32(self, blocks_u8: torch.Tensor,
                                   scales: torch.Tensor,
